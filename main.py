...
"We will have to print the updated board after every move in the game and thus we will make a fuction in which we'll define the printBoard function so that we can easily print the board every time by calling this function."
